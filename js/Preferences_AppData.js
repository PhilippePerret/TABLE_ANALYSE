...
const PreferencesAppData = [
    {type:'inputtext', id:'systeme_width',        default:1860, label:"Largeur (en pixels) des systèmes"}
  ...
  , {type:'inputtext', id:'marque_accords_size',  default:30,   label:"Taille (en pixels) des marques d'accord"}
  , {type:'inputtext', id:'marque_harmonie_size', default:30,   label:"Taille (en pixels) des marques d'harmonie"}
